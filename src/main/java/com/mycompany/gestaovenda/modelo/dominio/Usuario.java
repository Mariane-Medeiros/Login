...
public class Usuario {
    ...
    public boolean equals(Object obj) {
        ...
        final Usuario other = (Usuario) obj; //converte o obj 'obj' para a classe usuario
        return Objects.equals(this.id, other.id); //usa a conversao ali de cima para acesar id e fazer comparaçao
    }
